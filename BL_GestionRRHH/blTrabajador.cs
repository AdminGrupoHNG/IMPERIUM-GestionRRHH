...
namespace BL_GestionRRHH
{
    public class blTrabajador
    {
        ...
        public string ActualizarBaja(int opcion, DateTime Fechabaja, string motivo_baja = "", string observaciones = "", string cod_empresa = "", string cod_trabajador = "", string flg_activo = "")
        {
        ...
        public string ActualizarInformacionDocumentosFamilia(string flg_Adjuntos, int opcionDoc, eTrabajador.eInfoFamiliar_Trabajador objTrab)
        {
            ...
            dictionary.Add("flg_DNI_documentofam", objTrab.flg_DNI_documentofam);
            dictionary.Add("flg_CERTIFICADOESTUDIOS_documentofam", objTrab.flg_CERTIFICADOESTUDIOS_documentofam);
