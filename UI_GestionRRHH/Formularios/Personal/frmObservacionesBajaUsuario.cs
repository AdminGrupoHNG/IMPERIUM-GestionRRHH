...
namespace UI_GestionRRHH.Formularios.Personal
{
    ...
    //DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            eTrabajador trab = new eTrabajador();
             trab = AsignarValor();
            result = unit.Trabajador.ActualizarBaja(2, Fechabaja: trab.Fechabaja, motivo_baja: trab.motivo_baja, observaciones: trab.observaciones, cod_empresa: empresa, cod_trabajador: trabajador, flg_activo:estado);
